...
public class DessinHorloge{
  ...
  public static void dessinerAiguille(Graphics gTmp, double angle ,int x, int y, double longueur, double largeur , Color couleur)
  {
		...
		//Color aFond = new Color(0,0,0);
	    gTmp.setColor(couleur); //Fond aiguille
	    gTmp.fillPolygon(tPolygonX, tPolygonY, 4);
	    gTmp.setColor(Color.black); //Contour aiguille
  ...
  public static void dessineHorloge(Graphics gTmp, int haut, int larg, int heure, int minutes, double secondes){
    ...
    Color cFond = new Color(255,255,255); //Fond horloge
    ...
    DessinHorloge.dessinerAiguille(gTmp,secondes/60.0, centreX, centreY, 0.45*taille,0.01*taille,Color.red);
